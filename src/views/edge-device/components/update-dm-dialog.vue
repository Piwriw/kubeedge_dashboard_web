  ...
  <div>
    <el-form ref="form" :rules="rules" :model="form" label-width="130px">
      ...
      >
        ...
        <el-input :disabled="true" style="width: 80%" v-model="form.name.value" :placeholder="form.name.placeholder" />
      </el-form-item>
      <el-form-item
      ...
      onSubmit(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$store.dispatch(
              'edge-device/updateDeviceModel', params
            ).then(() => {
              Message({
                message: '设备模板更新成功',
                type: 'success',
