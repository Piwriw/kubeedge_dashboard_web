  ...
  <div :class="['container', { 'sign-up-mode': isLogin }]">
      ...
      <div class="signin-signup">
        <form action="#" class="sign-in-form">
          ...
          <div class="input-field">
            ...
            <input type="text"  :value="loginForm.username" placeholder="用户名" />
          </div>
          <div class="input-field">
            <i><font-awesome-icon icon="fa-solid fa-lock" /></i>
            <input type="password" :value="loginForm.password"  placeholder="密码" />
          </div>
          <el-button class="btn solid" @click="handToDashboard">立即登录</el-button>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        ...
        <img src="@/assets/signin.png" class="image" alt="" />
      </div>
