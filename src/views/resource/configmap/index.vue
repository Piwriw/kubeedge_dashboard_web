...
<i class="el-icon-arrow-down el-icon--right"></i>
      ...
      <el-dropdown-menu slot="dropdown">
        <el-dropdown-item v-for="ns in  nsList" @click.native="getCMList(ns.metadata.name)">
          {{ ns.metadata.name }}
        </el-dropdown-item>
      </el-dropdown-menu>
    </el-dropdown>
...
import {getConfigMapList} from "@/api/resource"
import {getConfigMapDetails} from "@/api/resource"
...
export default {
  ...
  methods: {
    ...
    showAppDetail(name, namespace) {
      getConfigMapDetails(name, namespace).then(res => {
    ...
    getCMList(namespace) {
      ...
      getConfigMapList(namespace).then(res => {
